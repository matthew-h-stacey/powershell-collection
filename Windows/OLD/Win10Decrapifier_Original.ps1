...
#
#IMPORTANT NOTE: Make sure your Windows 10 is fully updated with July 2018 updates or later before running the script. June 2018 update (and therefore the July 2018 ISO release) broke the Powershell cmdlet that removes
#		 		 provisioned appx packages, so some apps would return for new user profiles. This was fixed by MS in the July 2018 update.
#		  
